//poi点详细信息爬取 GetDetailedInformation.js 
//结果写入DetailInformation.json集中保存 再通过ReadDetailedInformation.js把属性写入geojson地图数据
...
list.forEach(floor => {
    var path = `E:\\indoorMap\\data\\zsgc2\\${floor}_Point.geojson`; //根据具体存放路径和地图数据文件名称修改
