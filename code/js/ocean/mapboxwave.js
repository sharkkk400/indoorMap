...
// testdataReal[0]['header']['lo1'] = 0;
// testdataReal[0]['header']['la1'] = 90;
// testdataReal[0]['header']['d'] = 0.25;
// testdataReal[0]['header']['nx'] = 1440;
// testdataReal[0]['header']['ny'] = 720;
// testdataReal[0]['header']['lo2']=360.0;
...
// testdataReal[1]['header']['lo1'] = 0;
// testdataReal[1]['header']['la1'] = 90;
// testdataReal[1]['header']['d'] = 0.25;
// testdataReal[1]['header']['nx'] = 1440;
// testdataReal[1]['header']['ny'] = 720;
// testdataReal[1]['header']['lo2']=360.0;
// testdataReal[1]['header']['la2']= -90;
// testdataReal[1]['header']['parameterName']="VGRD_WIND";

String.prototype.PadRight = function(e, t) {
    return null !== t ? this.PadHelper(e, t, !0) : this.PadHelper(e, " ", !0)
};

String.prototype.PadHelper = function(e, t, A) {
    if (this.length < e) {
        var n = new String;
        for (i = 1; i <= e - this.length; i++)
            n += t;
        return A ? this + n : n + this
    }
    return this
};
...
function WaveLayer() {
    ...
    this.putCanvas = function () {
        ...
        //粒子
        if (this._map.getSource('waveanimation')) {
            var source = map.getSource('waveanimation');
            source.setCoordinates([
                [left, top],
                [right, top],
                [right, bottom],
            ...
            Config.map.addSource('waveanimation', {
                type: 'canvas',
                canvas: 'waveanimation',
                coordinates: [
                    [left, top],
                    [right, top],
                    [right,bottom],
...
//             value = (value / 6) * 4 + 2;//值做了一个小调整
//             var angle_origin = b / 255 * 360;
//             var angle = angle_origin - 90;
//             angle = angle < 0 ? angle + 360 : angle;
//             angle = 360 - angle;
//             angle = angle * Math.PI / 180;
//             var u = Math.cos(angle) * value * -1;
//             var v = Math.sin(angle) * value * -1;
//             if (angle_origin === 0) {
//                 u = 0;
//                 v = 0;
//             }
